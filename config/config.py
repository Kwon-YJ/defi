...
class Config:
    ...
    # 네트워크 설정
    ethereum_mainnet_rpc: str = os.getenv('ETHEREUM_MAINNET_RPC', 'https://eth-mainnet.alchemyapi.io/v2/')
    ethereum_mainnet_ws: str = os.getenv('ETHEREUM_MAINNET_WS', 'wss://eth-mainnet.alchemyapi.io/v2/')
